	...
	internal static class GearItem_Deserialize
	{
		...
		private static void Postfix(GearItem __instance)
		{
			...
			foreach (UnityEngine.Component component in components)
			{
				...
				{
					MelonLogger.Msg("Deserializing custom save data for item {0} failed: {1}.", __instance.name, e.Message);
				}
			}
		}
	}
	...
	internal static class GearItem_Serialize
	{
		...
		private static void Prefix(GearItem __instance)
		{
			...
			foreach (UnityEngine.Component component in components)
			{
				...
				{
					MelonLogger.Msg("Serializing custom save data for item {0} failed: {1}.", __instance.name, e.Message);
				}
			}
		}
	}
